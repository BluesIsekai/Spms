            ...
            <header className="ec-header">
                ...
                <div className="gd-search-container ec-search">
                    ...
                    {searchQuery.trim().length > 0 && (
                        <button className="gd-icon-btn" style={{ padding: 0 }} onClick={() => setSearchQuery("")}>
                            <svg
                                width="14"
                                height="14"
                                viewBox="0 0 24 24"
                    ...
                    displayedStocks.map((stock, i) => {
                        ...
                        return (
                            <div
                                ...
                                onClick={() => {
                                    void recordRecentView(user?.id, stock.symbol, {
                                        companyName: stock.name,
                                        sourcePage: "explore-category",
                                    });
                                    navigate(`/chart/${encodeURIComponent(stock.symbol)}`);
                                }}
                            >
                                ...
                                <div className="ec-item-right">
                                    ...
                                    {filter !== "Gainers" && filter !== "Losers" && (
                                        <div className={`ec-item-subval ${isUp ? "up" : "down"}`}>
                                            {isUp ? "+" : "−"}₹{Math.abs(stock.change).toFixed(2)} ({isUp ? "+" : "−"}
