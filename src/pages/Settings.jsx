...
export default function Settings() {
    ...
    const handleReset = async () => {
        ...
        if (
            !window.confirm(
                `WARNING: This will wipe all holdings and transactions, and reset your wallet to ₹${balance.toLocaleString("en-IN")}. Are you sure?`,
            )
        ) {
            return;
        }
    ...
    const handleLogout = async () => {
        if (!window.confirm("Log out of your account now?")) {
            return;
        }
        ...
        <div className="page-container page-settings">
            ...
            <div className="settings-content">
                ...
                <Card className="danger-zone">
                    <h2>Danger Zone</h2>
                    <p>
                        Resetting your portfolio will erase all active holdings, purge your transaction history, and
                        reset your paper wallet back to the initial default balance. Watchlist items are retained.
                    </p>
